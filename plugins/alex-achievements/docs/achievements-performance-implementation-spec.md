# Alex Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.alex/plugins/alex-achievements/state.json` (existing unlock state)
  - `~/.alex/plugins/alex-achievements/scan_snapshot.json` (new)
  - `~/.alex/plugins/alex-achievements/scan_checkpoint.json` (new)
