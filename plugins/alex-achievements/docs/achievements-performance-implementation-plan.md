# Alex Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.alex/plugins/alex-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.alex/plugins/alex-achievements/scan_checkpoint.json`.
