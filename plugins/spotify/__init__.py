...
``_check_spotify_available()`` — when the user has not run ``alex auth
spotify``, the tools remain registered (so they appear in ``alex
...
The Spotify auth flow (``alex auth spotify``), CLI plumbing, and docs
