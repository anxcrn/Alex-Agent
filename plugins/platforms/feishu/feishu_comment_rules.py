...
Config: ~/.alex/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.alex/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_alex_home()`` helper (ALEX_HOME-aware and
...
RULES_FILE = get_alex_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_alex_home() / "feishu_comment_pairing.json"
