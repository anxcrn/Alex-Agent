...
required — uses aiohttp which is already a Alex dependency.
...
def interactive_setup() -> None:
    ...
    ``alex_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Alex delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # alex_cli/setup.py::_setup_mattermost function.
