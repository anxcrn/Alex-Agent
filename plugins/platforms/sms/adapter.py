...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Alex gateway adapter.

    Each inbound phone number gets its own Alex session (multi-tenant).
...
# static dict in alex_cli/gateway.py, and the _send_sms dispatch in
