# nix/web.nix — Alex Web Dashboard (Vite/React) frontend build
{ pkgs, alexNpmLib, ... }:
let
  npm = alexNpmLib.mkNpmPassthru { folder = "web"; attr = "web"; pname = "alex-web"; };
...
pkgs.buildNpmPackage (npm // {
  ...
  buildPhase = ''
    ...
    # outDir in vite.config.ts points to ../alex_cli/web_dist for the
