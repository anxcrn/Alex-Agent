...
{ ... }:
{
  perSystem =
    ...
    let
      ...
      alexNpmLib = self'.packages.default.passthru.alexNpmLib;
      ...
      # Non-npm packages may have their own devShellHook (e.g. alex-agent
    ...
    in
    {
      devShells.default = pkgs.mkShell {
        ...
        shellHook = ''
          echo "Alex Agent dev shell"
          ${combinedNonNpm}
          ${alexNpmLib.mkNpmDevShellHook npmPackageJsonPaths}
          echo "Ready. Run 'alex' to start."
        '';
      };
    };
}
