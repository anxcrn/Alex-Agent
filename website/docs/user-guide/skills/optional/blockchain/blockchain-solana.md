...
| | |
|---|---|
| Source | Optional — install with `alex skills install official/blockchain/solana` |
| Path | `optional-skills/blockchain/solana` |
| Version | `0.2.0` |
| Author | Deniz Alagoz (gizdusum), enhanced by Alex Agent |
| License | MIT |
...
Helper script path: ~/.alex/skills/blockchain/solana/scripts/solana_client.py
