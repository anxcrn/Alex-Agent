...
| | |
|---|---|
| Source | Optional — install with `alex skills install official/productivity/shopify` |
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"Alex","productType":"Apparel","tags":["test"]}}'
```
