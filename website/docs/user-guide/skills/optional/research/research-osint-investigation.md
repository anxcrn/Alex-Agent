...
| | |
|---|---|
| Source | Optional — install with `alex skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Alex Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $ALEX_OSINT_CACHE/icij/ (default: ~/.cache/alex-osint/icij/).
...
# Set ALEX_OSINT_UA=your-app/1.0 (your@email) to identify yourself
