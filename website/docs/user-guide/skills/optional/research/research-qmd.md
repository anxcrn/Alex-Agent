...
| | |
|---|---|
| Source | Optional — install with `alex skills install official/research/qmd` |
...
Alex Agent via the native MCP client. This is the preferred
...
Then configure Alex Agent to connect via HTTP:
