...
| | |
|---|---|
| Source | Optional — install with `alex skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.alex/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.alex/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Alex installs package this)
