...
| | |
|---|---|
| Source | Optional — install with `alex skills install official/health/neuroskill-bci` |
...
Connect Alex to a running [NeuroSkill](https://neuroskill.com/) instance to read
