...
Set your Tenor API key in your environment (add to `${ALEX_HOME:-~/.alex}/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/charan vankudoth/alex-agent/blob/main/skills/media/gif-search/url)`
