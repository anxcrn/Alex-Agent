...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to Alex Agent — dev setup, code style, PR process"
---

# Contributing

Thank you for contributing to Alex Agent! This guide covers setting up your dev environment, understanding the codebase, and getting your PR merged.
...
- Building a custom/local tool without modifying Alex core? Start with [Build a Alex Plugin](../guides/build-a-alex-plugin.md)
- Building a new built-in core tool for Alex itself? Start with [Adding Tools](./adding-tools.md)
