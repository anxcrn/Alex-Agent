---
sidebar_position: 0
title: "Run Nemotron 3 Ultra free in Alex Agent"
description: "Try NVIDIA Nemotron 3 Ultra on Nous Portal — free June 4–18 — with day 0 support in Alex Agent"
---
...
Select **Quick Setup**. Alex opens a browser tab and waits for you to finish the next steps.
...
When prompted to connect your account to Alex Agent, click **Connect**. You'll see a confirmation once it's linked.
...
- **Don't see the model in the list?** Make sure you finished the Nous Portal connection and that you're on the **Free** plan. In the CLI, `alex portal info` confirms you're logged in and routing through Nous.
...
- **[Run Alex Agent with Nous Portal](/guides/run-alex-with-nous-portal)** — Full Portal walkthrough: models, Tool Gateway, and verification
