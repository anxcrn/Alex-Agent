...
slug: /
sidebar_position: 0
title: "Alex Agent Documentation"
description: "The self-improving AI agent Created by charan vankudoth. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The official, self-improving AI agent created by charan vankudoth. The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
After installing, run `alex setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nous Portal](/integrations/nous-portal).
:::
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Alex safely  |
| 🧭 **[Use MCP with Alex](/guides/use-mcp-with-alex)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Alex](/guides/use-voice-mode-with-alex)** | Hands-on setup and usage patterns for Alex voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Alex' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Alex                              |
...
- **Created by model trainers** — Created by [charan vankudoth](https://charan vankudoth.com), the lab behind Alex, Nomos, and Psyche. Works with [Nous Portal](https://portal.charan vankudoth.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Created by [charan vankudoth](https://charan vankudoth.com) — the lab behind Alex, Nomos, and Psyche models
