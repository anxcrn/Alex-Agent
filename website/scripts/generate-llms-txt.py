#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Alex docs site.
...
Both publish at:
  https://alex-agent.charan vankudoth.com/docs/llms.txt
  https://alex-agent.charan vankudoth.com/docs/llms-full.txt
...
SITE_BASE = "https://alex-agent.charan vankudoth.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Alex as a Python Library", None),
        ("guides/use-mcp-with-alex", "Use MCP with Alex", None),
        ("guides/use-voice-mode-with-alex", "Use Voice Mode with Alex", None),
        ("guides/use-soul-with-alex", "Use SOUL.md with Alex", None),
        ("guides/build-a-alex-plugin", "Build a Alex Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Alex"),
...
def emit_llms_index() -> str:
    ...
    lines: list[str] = []
    lines.append("# Alex Agent")
    lines.append("")
    lines.append(
        "> The self-improving AI agent Created by charan vankudoth. A terminal-native "
    ...
    lines.append("")
    lines.append(
        "Install: `curl -fsSL https://raw.githubusercontent.com/charan vankudoth/"
        "alex-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/charan vankudoth/alex-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Alex Agent — Full Documentation\n",
        (
            "This file is the entire Alex Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Alex, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://alex-agent.charan vankudoth.com/docs\n",
        "Short index: https://alex-agent.charan vankudoth.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
