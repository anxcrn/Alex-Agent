...
Both publish at:
  https://alex-agent.nousresearch.com/docs/llms.txt
  https://alex-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://alex-agent.nousresearch.com/docs"
...
def emit_llms_index() -> str:
    ...
    lines.append("")
    lines.append("Repo: https://github.com/NousResearch/alex-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    chunks: list[str] = [
        ...
        "Canonical site: https://alex-agent.nousresearch.com/docs\n",
        "Short index: https://alex-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
