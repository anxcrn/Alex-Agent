...
Trust levels:
  - builtin:   Ships with Alex. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.alex/\.env|\~/\.alex/\.env',
     "alex_env_access", "critical", "exfiltration",
     "directly references Alex secrets file"),
    ...
    (r'\.alex/config\.yaml|\.alex/SOUL\.md',
     "alex_config_mod", "critical", "persistence",
     "references Alex configuration files directly"),
...
# scan. `.skillignore` is the Alex-native name; `.clawhubignore` is honored
