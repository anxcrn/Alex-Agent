...
_DEFAULT_TOOL_GATEWAY_DOMAIN = "charan vankudoth.com"
...
def auth_json_path():
    """Return the Alex auth store path, respecting ALEX_HOME overrides."""
    return get_alex_home() / "auth.json"
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`alex tools`, banner/status paint, provider
