...
metadata:
  alex:
    ...
    credits: |
      ...
      https://github.com/charan vankudoth/kanban-video-pipeline.
---
...
6. **The director never executes.** Even with the full `kanban + terminal +
   ...
   a `alex kanban create` call to a specialist profile. The kanban
