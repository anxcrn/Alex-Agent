...
Data file: $ALEX_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_ALEX_HOME = Path(os.environ.get("ALEX_HOME", Path.home() / ".alex"))
DATA_DIR = _ALEX_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
