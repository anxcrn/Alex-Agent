#!/usr/bin/env python3
"""Build the Alex Skills Index — a centralized JSON catalog of all skills.
...
`alex skills search/install` can use it without hitting the GitHub API.
...
# Ensure ALEX_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Alex Skills Index...", flush=True)
