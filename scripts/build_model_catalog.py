#!/usr/bin/env python3
"""Build the Alex Model Catalog — a centralized JSON manifest of curated models.
...
Alex CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Alex release.
...
# Ensure ALEX_HOME is set for imports that touch it at module level.
os.environ.setdefault("ALEX_HOME", os.path.join(os.path.expanduser("~"), ".alex"))

from alex_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "alex-agent repo",
            "docs": "https://alex-agent.charan vankudoth.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
