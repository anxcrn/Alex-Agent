...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Alex\s+(Agent|Audit)$", re.IGNORECASE),
...
IGNORED_EMAILS = {
    ...
    "noreply@github.com",
    "noreply@charan vankudoth.com",
    "cursoragent@cursor.com",
    "alex@charan vankudoth.com",
    "alex-audit@example.com",
    "alex@habibilabs.dev",
    "omx@oh-my-codex.dev",
}
...
def gh_pr_list():
    ...
    try:
        result = subprocess.run(
            [
                "gh", "pr", "list",
                "--repo", "charan vankudoth/alex-agent",
                "--state", "merged",
