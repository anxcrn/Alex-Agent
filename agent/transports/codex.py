...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Alex's web-provider config and
        ...
        # native search engine for xAI sessions instead of Alex's
        # configured web provider (Tavily/etc.), and those results bypass
        # Alex's tool-trace / citation plumbing (they arrive baked into the
