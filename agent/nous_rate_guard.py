...
(3 SDK retries x 3 Alex retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = os.path.join(os.path.expanduser("~"), ".alex")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Alex, ...) behind one endpoint.  A 429 can mean either:
