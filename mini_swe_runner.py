#!/usr/bin/env python3
"""
SWE Runner with Alex Trajectory Format

A runner that uses Alex-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Alex-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Alex-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Alex format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Alex-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Alex-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Alex Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Alex-Agent's built-in execution environments
    and outputs trajectories in Alex-Agent format.
    """
    ...
    def _convert_to_alex_format(
        ...
        """
        Convert internal message format to Alex trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Alex trajectory format
        trajectory = self._convert_to_alex_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Alex trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Alex Trajectory Format")
    print("=" * 60)
