import { Box, type ScrollBoxHandle, stringWidth, Text } from '@alex/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (ALEX_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (ALEX_DEV_CREDITS), lowest priority,
