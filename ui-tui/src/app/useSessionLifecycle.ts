...
import type { ScrollBoxHandle } from '@alex/ink'
import { evictInkCaches } from '@alex/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.ALEX_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
