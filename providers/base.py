...
def _profile_user_agent() -> str:
    """Return a ``alex-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from alex_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"alex-cli/{_ver}"
    except Exception:
        return "alex-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # alex-cli UA so the catalog endpoint is reachable.
