"""
Skills configuration for Alex Agent.
`alex skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.alex/config.yaml under:
...
from alex_cli.config import cfg_get, load_config, save_config
from alex_cli.colors import Colors, color
from alex_cli.platforms import PLATFORMS as _PLATFORMS
