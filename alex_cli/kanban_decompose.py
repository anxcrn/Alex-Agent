...
Invoked by ``alex kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Alex Agent board.
...
def _profile_author() -> str:
    """Mirror of ``alex_cli.kanban._profile_author``."""
    return (
