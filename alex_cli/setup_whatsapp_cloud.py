...
Entry point: ``alex whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``alex_cli/main.py``).
...
Alex gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Alex to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Alex needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Alex gateway in another terminal:")
    print("         alex gateway")
    print()
    ...
    print()
    print("  Docs: https://alex-agent.charan vankudoth.com/docs/user-guide/")
