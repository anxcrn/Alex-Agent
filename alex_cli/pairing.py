...
Usage:
    alex pairing list              # Show all pending + approved users
    alex pairing approve <platform> <code>  # Approve a pairing code
    alex pairing revoke <platform> <user_id> # Revoke user access
    alex pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle alex pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: alex pairing {list|approve|revoke|clear-pending}")
        print("Run 'alex pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.alex/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'alex pairing list' to see pending codes.\n")
