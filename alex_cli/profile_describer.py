...
Used by ``alex profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``alex_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the Alex Agent kanban board.
...
Rules:
  ...
  - Never write "Alex Agent profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_alex_home())
        else:
