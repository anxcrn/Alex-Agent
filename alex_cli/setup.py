...
_DOCS_BASE = "https://alex-agent.nousresearch.com/docs"
...
def _setup_webhooks():
    ...
    print()
    print_info("   Full guide: https://alex-agent.nousresearch.com/docs/user-guide/messaging/webhooks/")
    print()
    ...
    print_info("   https://alex-agent.nousresearch.com/docs/user-guide/messaging/webhooks/#configuring-routes")
    print()
