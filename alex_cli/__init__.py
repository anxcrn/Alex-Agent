"""
Alex CLI - Unified command-line interface for Alex Agent.

Provides subcommands for:
- alex chat          - Interactive chat (same as ./alex)
- alex gateway       - Run gateway in foreground
- alex gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `alex setup` on a fresh Pi.
    ...
    alex_cli/stdio.py::configure_windows_stdio() runs later from the entry
