 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `alex_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Alex Teal",
  description: "Classic dark teal — the canonical Alex look",
  palette: {
...
/**
 * Nous Blue — the inverted "light mode" Alex look, ported from the
 ...
 * nousnet-web's <body> is white; alex-agent's App root is `bg-black`,
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Alex Teal (Large)",
  description: "Alex Teal with bigger fonts and roomier spacing",
