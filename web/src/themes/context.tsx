...
const STORAGE_KEY = "alex-dashboard-theme";
...
const FONT_STORAGE_KEY = "alex-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `alex_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "alex-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-alex-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-alex-theme-font", "true");
