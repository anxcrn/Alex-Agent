 ...
 *
 * Plugins call window.__ALEX_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__ALEX_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__ALEX_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__ALEX_PLUGIN_SDK__ = {
    ...
    // window.__ALEX_SESSION_TOKEN__ directly.
    authedFetch,
