/**
 * Alex Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__ALEX_PLUGIN_SDK__`` and
 * ``window.__ALEX_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__ALEX_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``AlexPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@alex/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__ALEX_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__ALEX_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__ALEX_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface AlexPluginSDK {
...
declare global {
  interface Window {
    __ALEX_PLUGIN_SDK__?: AlexPluginSDK;
    __ALEX_PLUGINS__?: PluginRegistry;
  }
}
