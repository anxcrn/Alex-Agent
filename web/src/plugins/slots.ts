 ...
 * `window.__ALEX_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Alex brand in the top bar
 ...
 *  `window.__ALEX_PLUGINS__.registerSlot(...)`.
 *
