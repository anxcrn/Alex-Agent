 ...
 *
 * Values mirror alex_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Alex default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Alex' default when unset). */
