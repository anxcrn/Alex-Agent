...
cd apps/desktop
XCURSOR_SIZE=24 ALEX_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/alex-typing
# → /tmp/alex-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/alex-typing.before.heapsnapshot
# → /tmp/alex-typing.after.heapsnapshot
```
