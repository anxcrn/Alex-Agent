...
import { getSessionMessages, listAllProfileSessions } from '@/alex'
...
import type { SessionInfo, SessionMessage } from '@/types/alex'
    ...
    async (href: string) => {
      try {
        if (window.alexDesktop?.openExternal) {
          await window.alexDesktop.openExternal(href)
        } else {
