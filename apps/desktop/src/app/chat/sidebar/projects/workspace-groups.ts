...
import type { ProjectInfo, SessionInfo } from '@/alex'
 ...
 * repo shows its branches/worktrees even when they have no Alex sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: AlexGitWorktree[]
): SidebarSessionGroup[] {
