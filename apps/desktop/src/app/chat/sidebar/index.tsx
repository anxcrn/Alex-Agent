...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/alex'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('alex:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('alex:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Alex to
...
interface SidebarSessionsSectionProps {
  ...
  projectRepoWorktrees?: Record<string, AlexGitWorktree[]>
