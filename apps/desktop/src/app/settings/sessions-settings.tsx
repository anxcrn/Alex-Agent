...
import { deleteSession, listAllProfileSessions, setSessionArchived } from '@/alex'
...
// / Program Files), which buried any files Alex wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.alexDesktop` is
    ...
    const settings = window.alexDesktop?.settings
