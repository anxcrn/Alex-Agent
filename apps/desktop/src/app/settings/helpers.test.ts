...
describe('settings helpers', () => {
  ...
  it('reads and writes nested config paths', () => {
    const config: AlexConfigRecord = { display: { theme: 'mono' } }
  ...
  describe('providerGroup', () => {
    ...
    it('prefers the longest matching prefix so CN/regional buckets win', () => {
      ...
      // ALEX_QWEN_ shares the ALEX_ stem with other integrations.
      expect(providerGroup('ALEX_QWEN_BASE_URL')).toBe('DashScope (Qwen)')
