...
import type { ActionStatusResponse, ToolEnvVar, ToolProvider, ToolsetConfig } from '@/types/alex'
 ...
 * log inline — the GUI equivalent of the install step `alex tools` runs
