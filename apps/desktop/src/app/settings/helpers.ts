import type { AlexConfigRecord, ToolsetInfo } from '@/types/alex'
...
export function getNested(obj: AlexConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: AlexConfigRecord, path: string, value: unknown): AlexConfigRecord {
...
function personalityOptions(config: AlexConfigRecord): string[] {
