...
import type { AlexReadDirEntry, AlexReadDirResult } from '@/global'
...
export type ProjectTreeEntry = AlexReadDirEntry
...
function ignoredBy(rules: GitignoreRule[], entry: AlexReadDirEntry) {
...
async function filterIgnored(entries: AlexReadDirEntry[], rootPath: string, dirPath: string) {
...
export async function readProjectDir(dirPath: string, rootPath = dirPath): Promise<AlexReadDirResult> {
