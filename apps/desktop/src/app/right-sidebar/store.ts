...
const TAKEOVER_KEY = 'alex.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Alex can't clear via the API — the user
 *  sees exactly what runs instead of Alex silently deleting their creds. */
