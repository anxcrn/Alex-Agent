import type { AlexReviewFile } from '@/global'
...
export function buildReviewFlatList(files: AlexReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: AlexReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
