...
export const en: Translations = {
  ...
  boot: {
    ready: 'Alex Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Alex settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingAlexDesktop: 'Starting Alex Desktop…'
    },
    errors: {
      backgroundExited: 'Alex background process exited.',
      backgroundExitedDuringStartup: 'Alex background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Alex backend is older than this desktop build and may not work correctly. Update to align them.',
    updateAlex: 'Update Alex',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Alex Desktop.',
    ...
    native: {
      ...
      inputBody: 'Alex is waiting for your response.',
      turnDoneTitle: 'Alex finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Alex defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Alex is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Alex asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Alex was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Alex follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Alex is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Alex, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Alex checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Alex configuration...',
    ...
    gateway: {
      ...
      intro:
        'Alex Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Alex backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset ALEX_DESKTOP_REMOTE_URL and ALEX_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Alex backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Alex backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      remoteUrlTitle: 'Remote URL',
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /alex.',
      ...
      restartingMessage: 'Alex Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Alex ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Alex runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Alex to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Alex to generate pets.',
      backgroundHint: 'You can close this — Alex will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Alex desktop' },
    ...
    alexActiveSessions: (version, count) => `Alex ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@alex:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Alex environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Alex will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      deleteConfirm: 'This removes the saved project from Alex. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Alex...',
    placeholderReconnecting: 'Reconnecting to Alex…',
    ...
    attachUrlDesc: 'Alex will fetch the page and include it as context for this turn.',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Alex…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Alex…',
    ...
    unsupportedMessage: 'This version of Alex can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Alex from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Alex will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Alex desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Alex updater takes over in its own window and reopens Alex automatically when it’s done. Please don’t reopen Alex yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Alex reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Alex reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Alex needs a one-time install',
    ...
    settingUpTitle: 'Setting up Alex Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Alex CLI or desktop instance is running. Stop any running Alex instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Alex installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Alex Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Alex is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Alex…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Alex',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Alex at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Alex connects automatically',
      loopback: 'Opens your browser to sign in — Alex connects automatically',
    ...
    authorizeThere: 'Authorize Alex there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Alex there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Alex Desktop v${version}`,
      ...
      gatewayTitle: 'Alex inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Alex will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Alex is restarting...',
      askRestart: 'Ask Alex to restart the server',
      lookingRestart: taskId => `Alex is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Alex is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Alex finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Alex could not restart the server.',
      stillWorking:
        'Alex is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Alex is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Alex gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.alex/config.yaml). Alex won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Alex needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Alex needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Alex Desktop to use Save Image.',
    restartToSaveImages: 'Restart Alex Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `alex gateway` running?'
    }
  },
