...
const desktopWindow = window as unknown as { alexDesktop?: Window['alexDesktop'] }
const initialAlexDesktop = desktopWindow.alexDesktop

function installDesktopBridge(partial: Partial<Window['alexDesktop']> = {}) {
  desktopWindow.alexDesktop = {
    fetchLinkTitle: vi.fn().mockResolvedValue(''),
    openExternal: vi.fn().mockResolvedValue(undefined),
    ...partial
  } as unknown as Window['alexDesktop']
}
...
afterEach(() => {
  ...
  if (initialAlexDesktop) {
    desktopWindow.alexDesktop = initialAlexDesktop
  } else {
    delete desktopWindow.alexDesktop
  }
})
...
describe('external link helpers', () => {
  ...
  it('deduplicates in-flight title fetches and caches results', async () => {
    ...
    installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['alexDesktop']['fetchLinkTitle'] })
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['alexDesktop']['openExternal'] })
