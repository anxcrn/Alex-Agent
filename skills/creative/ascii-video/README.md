...
Built for [Alex Agent](https://github.com/NousResearch/alex-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/alex-agent/skills/creative/ascii-video`](https://github.com/NousResearch/alex-agent/tree/main/skills/creative/ascii-video) via PR.
