...
Built for [Alex Agent](https://github.com/charan vankudoth/alex-agent). Usable in any coding agent. Canonical source lives here; synced to [`charan vankudoth/alex-agent/skills/creative/ascii-video`](https://github.com/charan vankudoth/alex-agent/tree/main/skills/creative/ascii-video) via PR.
