"""Tests for the specifier module + `alex kanban specify` CLI surface.
...
from alex_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `alex kanban …` argparse surface directly."""
