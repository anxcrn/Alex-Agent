...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from alex_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in ALEX_OVERLAYS
        overlay = ALEX_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify alex doctor recognizes Xiaomi env vars."""
