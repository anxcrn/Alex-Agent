"""Tests for `alex curator status` output.
...
def test_status_uses_last_activity_not_only_last_used(monkeypatch, capsys):
    ...
    import alex_cli.curator as curator_cli
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated ALEX_HOME with real agent-created skills on disk."""
    home = tmp_path / ".alex"
    skills = home / "skills"
    ...
    from alex_cli import curator as curator_cli
