"""Tests for the interactive session browser (`alex sessions browse`).
...
from alex_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """alex sessions browse should be parseable."""
