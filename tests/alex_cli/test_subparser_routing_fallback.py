...
The main() function in alex_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `alex -c model`
...
def _build_parser():
    """Build a minimal replica of the alex top-level parser."""
