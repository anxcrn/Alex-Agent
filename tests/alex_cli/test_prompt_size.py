"""Tests for the ``alex prompt-size`` diagnostic (issue #34667)."""

import json

import pytest

from alex_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(alex_home, memory_text="", user_text=""):
    mem_dir = alex_home / "memories"
...
def _seed_skill(alex_home, name, description):
    skill_dir = alex_home / "skills" / "demo" / name
