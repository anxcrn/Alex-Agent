"""Tests for Bug #12905 fix — stale OAuth token detection in alex model flow.
...
class TestStaleOAuthTokenDetection:
    ...
    def test_stale_oauth_token_triggers_reauth(self, tmp_path, monkeypatch, capsys):
        ...
        monkeypatch.setattr("alex_cli.secret_prompt.masked_secret_prompt", lambda _: "")

        from alex_cli.main import _model_flow_anthropic
        cfg = {}
