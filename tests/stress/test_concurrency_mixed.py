...
def worker_loop(worker_id: int, alex_home: str, result_file: str) -> None:
...
def reclaimer_loop(alex_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="alex_mixed_stress_")
    print(f"ALEX_HOME = {home}")
