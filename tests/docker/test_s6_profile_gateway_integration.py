...
The unit tests in tests/alex_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned alex-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/alex")
from alex_cli.service_manager import S6ServiceManager
