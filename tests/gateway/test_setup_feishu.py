"""Tests for _setup_feishu() in alex_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("alex_cli.config.save_env_value", side_effect=mock_save), \
         patch("alex_cli.config.get_env_value", side_effect=mock_get), \
         patch("alex_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("alex_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("alex_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("alex_cli.cli_output.print_header"), \
         patch("alex_cli.cli_output.print_info"), \
         patch("alex_cli.cli_output.print_success"), \
         patch("alex_cli.cli_output.print_warning"), \
         patch("alex_cli.cli_output.print_error"), \
