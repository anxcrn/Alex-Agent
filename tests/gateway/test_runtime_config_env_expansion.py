...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("ALEX_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("ALEX_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    monkeypatch.delenv("ALEX_GATEWAY_BUSY_INPUT_MODE", raising=False)
    monkeypatch.delenv("ALEX_RESTART_DRAIN_TIMEOUT", raising=False)
    monkeypatch.delenv("ALEX_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
