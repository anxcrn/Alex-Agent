...
def store(tmp_path, monkeypatch):
    ...
    ~/.alex/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at alex_state import time, before pytest's ALEX_HOME monkeypatch
    fires — the autouse fixture's ALEX_HOME override doesn't help here.)
    """
    import alex_state
